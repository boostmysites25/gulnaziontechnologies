          ...
          >
            <div className="flex flex-col gap-7">
              <h2 className="heading-2">
                {isWebDevelopment
                  ? "Empowering Brands with Innovative Web Development Solutions"
                  : "Transforming Ideas into Successful Mobile Applications"}
              </h2>
              <p className="desc">
                {isWebDevelopment
                  ? "We blend creativity with technical expertise to build websites that not only reflect your brand’s identity but also deliver an optimized, seamless experience across all devices. Let us help you captivate your audience and accelerate your business growth."
                  : "Whether you're a budding startup or an established enterprise, we offer tailored app development services that align with your business objectives. Our apps drive user engagement, enhance functionality, and scale with your growth, helping you stay ahead in a competitive market."}
              </p>
            </div>
        ...
        <div className="wrapper">
          <div className="h-full grid md:grid-cols-2 gap-10 py-5">
            <div className="flex flex-col gap-4">
              ...
              <p className="desc">
                At Gulnazion Technologies, we are excited to help you achieve your
                business goals with our innovative and tailored digital
                solutions. Whether you’re looking to create a new website, build
                a mobile app, or leverage the power of AI, blockchain, or cloud
                computing, we’re here to guide you through every step of the
                process.
              </p>
              <img
                src={image}
