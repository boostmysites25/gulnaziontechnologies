  ...
  const developmentPhases = [
    {
      ...
      description:
        "Conducted in-depth research, stakeholder interviews, and competitive analysis to define project scope and requirements.",
      icon: <FaLightbulb className="text-yellow-500" />,
    },
    {
      phase: "Design & Prototyping",
      description:
        "Created wireframes, user flows, and interactive prototypes to visualize the solution and gather early feedback.",
      icon: <MdOutlineDesignServices className="text-blue-500" />,
    },
    {
      phase: "Development",
      description:
        "Built the core functionality using modern development practices, with regular code reviews and quality assurance.",
      icon: <FaCode className="text-green-500" />,
    },
    {
      phase: "Testing & Refinement",
      description:
        "Conducted thorough testing across devices and user scenarios, refining the solution based on feedback and performance metrics.",
      icon: <FaTools className="text-purple-500" />,
    },
    {
      phase: "Deployment & Launch",
      description:
        "Deployed the solution to production environments with monitoring systems in place to ensure smooth operation.",
    ...
    <>
      ...
      <div className="wrapper py-20">
            ...
            <div data-aos="fade-up" className="mb-16">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Our team approached this project with a focus on delivering
                  exceptional user experience while ensuring robust
                  functionality and scalability. By leveraging cutting-edge
                  technologies and best practices in {project.type} development,
                  we created a solution that not only meets current needs but is
                  also positioned for future growth and adaptation.
                </p>
              </div>
            </div>
                  ...
                  <div className="relative z-10 flex flex-col items-center">
                    ...
                    <div className="text-center">
                      <p className="pt-6 text-black max-w-3xl">
                        This {project.type} project for {project.title}{" "}
                        showcases our commitment to delivering exceptional user
                        experiences through innovative design and robust
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 relative overflow-hidden group">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-700">
                      This presented significant challenges in terms of user
                      experience design, technical implementation, and ensuring
                ...
                <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100 relative overflow-hidden group">
                  ...
                  <div className="relative">
                    ...
                    <p className="text-gray-700 mb-4">{project.outcome}</p>
                    <p className="text-gray-700">
                      Our approach combined innovative design thinking with
                      technical excellence to deliver a solution that exceeded
                      expectations and set new standards in the{" "}
                      {project.category} space.
                    </p>
        ...
        <div data-aos="fade-up" className="mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              We carefully selected the following technologies to ensure optimal
              performance, scalability, and maintainability for the{" "}
            ...
            <div className="mt-8">
              <p className="text-gray-700">
                This technology stack was chosen to provide a balance between
                cutting-edge capabilities and proven reliability. Each component
                plays a crucial role in delivering the robust functionality and
                exceptional user experience that defines the {project.title}{" "}
                project.
              </p>
            </div>
          </div>
        ...
        <div data-aos="fade-up" className="mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              The {project.title} project includes a comprehensive set of
              features designed to deliver exceptional value and address the
              core needs of users:
            </p>
            ...
            <div className="mt-8 p-6 bg-gray-50 rounded-xl">
              <p className="text-gray-700 italic">
                "These features work together to create a cohesive and powerful
                solution that addresses the complex needs of {project.category}{" "}
                users while maintaining an intuitive and engaging user
                experience."
              </p>
            </div>
          </div>
        ...
        <div data-aos="fade-up" className="mb-16">
          ...
          <div className="bg-white p-8 rounded-2xl shadow-lg border border-gray-100">
            <p className="text-lg text-gray-700 leading-relaxed mb-8">
              The development of {project.title} followed a structured approach
              to ensure quality, efficiency, and alignment with project goals:
            </p>
            <div className="relative">
              {/* Timeline line */}
        ...
        <div className="wrapper">
          <div data-aos="fade-up" className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-white/90 mb-10">
              Let's transform your ideas into reality with our expert team and
