          ...
          <div className="mx-auto max-w-7xl">
            <div className="grid items-center gap-8 lg:grid-cols-2">
              ...
              <div className="">
                ...
                >
                  Accelerating Progress with AI-Powered IT Solutions
                </h1>
                <p
                  data-aos="fade-up"
                  className="text-lg text-start leading-relaxed text-gray-600"
                >
                  At Gulnazion Technologies, we’re driven by the belief that every
                  business has the potential to thrive in the digital world.
                  Since our founding, we've been focused on delivering
                  innovative, high-quality digital solutions that help companies
                  succeed and grow. From custom websites and mobile apps to
                  advanced AI solutions and blockchain technology, our team is
                  committed to turning your vision into reality with precision
                  and creativity. <br />
                  <br /> We bring together a diverse team of experts who combine
                  their skills and experience to craft solutions that are not
                  only effective but also designed with your business in mind.
                  By collaborating closely with you, we ensure that we fully
                  understand your needs, goals, and challenges so that we can
